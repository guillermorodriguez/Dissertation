...
from config import *
import json
from urllib import * #import urllib.request
import traceback
    ...
    def __init__(self, query, results, use_api = True):
        ...
        try:
            if use_api in ("True", "T", "Yes", "Y", 1, True):
                ...
                _request = urllib.request.Request(_config.google_settings['url'] + urllib.request.quote(query))
